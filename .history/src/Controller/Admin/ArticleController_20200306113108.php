...
class ArticleController extends AbstractController
{
	...
	public function form(Request $request, EntityManagerInterface $entityManager, int $id = null, ProductRepository $productRepository): Response
	{
		...
		$model = $id ? $productRepository->find($id) : new Article();
	 ...
	 */
	public function delete(ArticleRepository $productRepository, EntityManagerInterface $entityManager, int $id): Response
	{
		/*
